...
function Sidebar({ activeBox, setActiveBox, notifactionCount }) {
  ...
  const MobileNav = () => {
    return (
      <div className=" min-h-12 z-[100] bg-white/80 p-2 sticky top-0 backdrop-blur-lg  ">
        ...
        {isOpen ? (
          ...
          <div className="h-full">
            ...
            <nav className="mt-8 ml-4 gap-3 flex flex-col  items-end mr-12 text-xl mb-4">
              ...
              <Link
                className={`${
                  activeBox === "announcement"
                    ? "underline underline-offset-2 font-semibold"
                    : ""
                } hover:underline`}
                onClick={() => {
                  setActiveBox("announcement");
                  setIsOpen(!isOpen);
                }}
                to="/admin-dashboard"
              >
    ...
    <>
      <nav>
        {isMobile ? (
          ...
          <aside
            className=" bg-gradient-to-br from-gray-800 to-gray-900 -translate-x-80 fixed inset-0 z-50 my-4 ml-4  h-[calc(90vh-32px)] w-72 rounded-xl transition-transform duration-300 xl:translate-x-0"
